    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="px-4 py-6 sm:px-0">
            ...
            <div class="flex justify-between items-center mb-8">
                ...
                <a href="<?php echo e(route('user.dashboard')); ?>" class="bg-gray-600 text-white hover:bg-gray-700 px-6 py-2 rounded-lg font-bold transition">Kembali</a>
            </div>
            ...
            <div class="flex space-x-8 border-b border-gray-200 mb-8" x-data="{ tab: 'products' }">
                ...
                <button @click="tab = 'purchases'" :class="tab === 'purchases' ? 'tab-active' : 'tab-inactive'" class="py-4 px-2 font-bold text-gray-700 hover:text-gray-900 transition">
                    <span class="text-lg">📦 Riwayat Pembelian (<?php echo e($stats['total_purchases'] ?? 0); ?>)</span>
                </button>
            </div>
            ...
            <div x-show="tab === 'products'" class="animate-slide-in" x-transition>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    <div class="card-hover bg-white p-6 rounded-2xl shadow-lg border-l-4 border-red-500">
                        ...
                        <p class="text-3xl font-black text-gray-900 mt-2">Rp <?php echo e(number_format($stats['total_spent'] ?? 0, 0, ',', '.')); ?></p>
                    </div>
                    <div class="card-hover bg-white p-6 rounded-2xl shadow-lg border-l-4 border-green-500">
                        ...
                        <p class="text-3xl font-black text-gray-900 mt-2"><?php echo e($stats['completed'] ?? 0); ?></p>
                    </div>
                    <div class="card-hover bg-white p-6 rounded-2xl shadow-lg border-l-4 border-blue-500">
                        ...
                        <p class="text-3xl font-black text-gray-900 mt-2"><?php echo e($stats['pending'] ?? 0); ?></p>
                    </div>
                    <div class="card-hover bg-white p-6 rounded-2xl shadow-lg border-l-4 border-purple-500">
                        ...
                        <p class="text-3xl font-black text-gray-900 mt-2"><?php echo e($stats['total_purchases'] ?? 0); ?></p>
                    </div>
                </div>
                            ...
                            <div class="card-hover bg-white rounded-2xl overflow-hidden shadow-lg">
                                ...
                                <div class="relative h-48 bg-gradient-to-br from-gray-200 to-gray-300 overflow-hidden">
                                    <?php if($product->image): ?>
                                        <img src="<?php echo e(asset('storage/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover hover:scale-110 transition-transform duration-300">
                                    <?php else: ?>
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="border-t pt-4 mb-4">
                                        <p class="text-3xl font-black text-red-600">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></p>
                                    </div>

                                    <!-- Action Buttons -->
                                    <?php if($product->stock > 0): ?>
                                        <form method="POST" action="<?php echo e(route('marketplace.buy', $product->id)); ?>" class="mb-2">
                                            <?php echo csrf_field(); ?>
                        ...
                        <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="card-hover bg-white p-6 rounded-2xl shadow-lg border-l-4 border-blue-500">
                                <div class="flex justify-between items-start mb-4">
                                    <div class="flex-1">
                                        <h3 class="text-lg font-bold text-gray-900 line-clamp-2"><?php echo e($transaction->item_name ?? $transaction->product?->name ?? 'Produk'); ?></h3>
                                        <p class="text-xs text-gray-500 mt-1">ID: #<?php echo e($transaction->id); ?></p>
                                    </div>
                                ...
                                <div class="space-y-3 mb-4 pb-4 border-b border-gray-200">
                                    <div class="flex justify-between text-sm">
                                        ...
                                        <span class="font-bold text-gray-900">Rp <?php echo e(number_format($transaction->amount, 0, ',', '.')); ?></span>
                                    </div>
                                    <div class="flex justify-between text-sm">
                                        <span class="text-gray-600">Jumlah:</span>
                                        <span class="font-bold text-gray-900"><?php echo e($transaction->transaction_data['quantity'] ?? 1); ?> pcs</span>
                                    </div>
                                    <div class="flex justify-between text-sm">
                                        <span class="text-gray-600">Total Pembayaran:</span>
                                        <span class="font-bold text-red-600 text-base">Rp <?php echo e(number_format($transaction->amount, 0, ',', '.')); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center text-xs text-gray-600 mb-4">
                                    ...
                                    <span><?php echo e(\Carbon\Carbon::parse($transaction->transaction_date ?? $transaction->created_at)->format('d M Y, H:i')); ?></span>
                                </div>
...
</html><?php /**PATH C:\laragon\www\PunkFootball\resources\views/user/marketplace.blade.php ENDPATH**/ ?>