    ...
    <div class="container mx-auto py-12 px-4">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-white rounded-xl shadow-lg hover:shadow-2xl transition duration-300 overflow-hidden flex flex-col">
                    ...
                    <div class="p-4 flex-1 flex flex-col">
                        ...
                        <p class="text-gray-600 text-sm mb-4 flex-1"><?php echo e(Str::limit($product->description, 80)); ?></p>
                        
                    <!-- Price -->
                        <div class="border-t pt-4 mb-4">
                            <p class="text-2xl font-bold text-gray-900">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></p>
                        </div>
                        
                        <!-- Actions -->
                        <div class="flex gap-2">
                            <a href="<?php echo e(route('marketplace.show', $product->id)); ?>" class="flex-1 text-center bg-gray-700 text-white py-2 px-3 rounded-lg hover:bg-gray-800 transition font-semibold text-sm">
                                Lihat Detail
                            </a>
                        </div>
                    </div>
        ...
        <?php if(auth()->check() && auth()->user()->hasRole('admin')): ?>
            <div class="text-center mt-16">
                <a href="<?php echo e(route('admin.products.index')); ?>" class="inline-block bg-gray-800 text-white px-8 py-3 rounded-lg hover:bg-gray-900 transition font-semibold shadow-lg">
                    🔧 Kelola Produk (Admin)
                </a>
            </div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\PunkFootball\resources\views/marketplace/index.blade.php ENDPATH**/ ?>