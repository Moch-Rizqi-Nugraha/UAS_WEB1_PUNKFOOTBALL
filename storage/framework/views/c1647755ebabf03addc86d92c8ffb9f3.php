                ...
                <div class="flex justify-between h-16">
                    ...
                    <div class="flex items-center space-x-4">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/dashboard')); ?>" class="text-gray-300 hover:text-white text-sm font-medium">Dashboard</a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="text-gray-300 hover:text-white text-sm font-medium">Masuk</a>
                            <?php if(Route::has('register')): ?>
                                <a href="<?php echo e(route('register')); ?>" class="bg-red-600 text-white hover:bg-red-700 px-4 py-2 rounded-lg text-sm font-medium">Daftar</a>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <section id="home" class="relative w-full h-screen bg-gradient-to-br from-gray-900 via-slate-800 to-black text-white flex items-center justify-center overflow-hidden">
            ...
            <div class="relative z-10 max-w-4xl mx-auto px-4 text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="<?php echo e(route('events.index')); ?>" class="bg-white text-gray-900 hover:bg-gray-100 px-8 py-4 rounded-xl font-bold text-lg transition duration-300 transform hover:scale-105">Jelajahi Event</a>
                    <a href="<?php echo e(route('marketplace.index')); ?>" class="border-2 border-white text-white hover:bg-red-600 px-8 py-4 rounded-xl font-bold text-lg transition duration-300 transform hover:scale-105">Belanja Sekarang</a>
                </div>
            </div>
        </section>
            ...
            <div class="max-w-6xl mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300">
                        ...
                        <a href="<?php echo e(route('events.index')); ?>" class="block w-full bg-red-600 text-white py-2 px-4 rounded-lg font-bold hover:bg-red-700 transition text-center">Daftar Sekarang</a>
                    </div>
                    <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300">
                        ...
                        <a href="<?php echo e(route('events.index')); ?>" class="block w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-bold hover:bg-blue-700 transition text-center">Daftar Sekarang</a>
                    </div>
                    <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300">
                        ...
                        <a href="<?php echo e(route('events.index')); ?>" class="block w-full bg-green-600 text-white py-2 px-4 rounded-lg font-bold hover:bg-green-700 transition text-center">Daftar Sekarang</a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="max-w-6xl mx-auto px-4">
                        ...
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300">
                                <?php if($product->image): ?>
                                    <img src="<?php echo e(asset('storage/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>" class="h-48 w-full object-cover">
                                <?php else: ?>
                                ...
                                <?php endif; ?>
                                <div class="p-4">
                                    <h3 class="text-lg font-bold mb-2 line-clamp-2"><?php echo e($product->name); ?></h3>
                                    <p class="text-gray-300 text-sm mb-4 line-clamp-2"><?php echo e($product->description); ?></p>
                                    <div class="flex justify-between items-center mb-4">
                                        <p class="text-2xl font-bold text-red-400">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></p>
                                        <?php if($product->stock > 0): ?>
                                            <span class="text-xs bg-green-600 px-2 py-1 rounded">Stok: <?php echo e($product->stock); ?></span>
                                        <?php else: ?>
                                            <span class="text-xs bg-red-600 px-2 py-1 rounded">Habis</span>
                                        <?php endif; ?>
                                    </div>
                                    <a href="<?php echo e(route('marketplace.index')); ?>" class="block w-full bg-red-600 text-white py-2 px-4 rounded-lg font-bold hover:bg-red-700 transition text-center text-sm">Beli</a>
                                </div>
                            </div>
                ...
                <?php else: ?>
                    <div class="text-center py-12">
                        ...
                        <a href="<?php echo e(route('marketplace.index')); ?>" class="inline-block bg-red-600 text-white hover:bg-red-700 px-8 py-3 rounded-xl font-bold transition">Jelajahi Marketplace</a>
                    </div>
                <?php endif; ?>
                <div class="text-center mt-12">
                    <a href="<?php echo e(route('marketplace.index')); ?>" class="inline-block bg-white text-gray-900 hover:bg-gray-100 px-8 py-3 rounded-xl font-bold text-lg transition">Lihat Semua Produk</a>
                </div>
            </div>
        </section>
                ...
                <?php if($galleries->count()): ?>
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-12">
                        <?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('galleries.show', $gallery)); ?>" class="group relative overflow-hidden rounded-xl bg-gray-300 aspect-square hover:shadow-xl transition duration-300">
                                <img src="<?php echo e(asset('storage/' . $gallery->image)); ?>" alt="<?php echo e($gallery->title); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
                                ...
                                <div class="absolute bottom-0 left-0 right-0 p-4 translate-y-6 group-hover:translate-y-0 transition-transform duration-300">
                                    <h3 class="text-white font-bold line-clamp-2"><?php echo e($gallery->title); ?></h3>
                                    <?php if($gallery->category): ?>
                                        <p class="text-gray-200 text-sm"><?php echo e($gallery->category); ?></p>
                                    <?php endif; ?>
                                </div>
                            </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="text-center">
                        <a href="<?php echo e(route('galleries.index')); ?>" class="inline-block bg-gray-900 text-white hover:bg-gray-800 px-8 py-3 rounded-xl font-bold transition">Lihat Semua Galeri</a>
                    </div>
                <?php endif; ?>
            </div>
        </section>
...
<?php /**PATH C:\laragon\www\PunkFootball\resources\views/welcome.blade.php ENDPATH**/ ?>